...
import org.firstinspires.ftc.teamcode.roadRunner.realsense.DriveTrainRealsense;
import org.firstinspires.ftc.teamcode.roadRunner.util.homar.ToggleBoolean;
...
public class BasicTeleOp extends LinearOpMode {
    ...
    private DriveTrainRealsense bot; //the robot class
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DriveTrainRealsense.USE_REALSENSE = false;
        bot = new DriveTrainRealsense(this);
        telemetry.update();
